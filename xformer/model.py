...
class Resblock(nn.Module):
  def __init__(self, cfg: Config, dtype=None, device=None):
    ...
    self.attn = nn.MultiheadAttention(cfg.d_model, cfg.n_head, batch_first=True, dtype=dtype, device=device)
  ...
  def forward(self, resid):
    ...
    attn_out, attn_pattern = self.attn(attn_ln, attn_ln, attn_ln,
